...
*/
simulate 1 [<=2500] {x[3],x[2],x[1],x[0]}
...
*/
E[globalTime<=30000;10] (max:Tr4.v)

/*
the max time of train1 stop at a station
*/
E[globalTime<=300;50] (max:C1.time)

/*

*/
E[globalTime<=300;1000] (max:T1.cost)

/*
time<=300 means the time of one normal run of a train.
*/
Pr[globalTime<=300](<>T1.cost>=4)
